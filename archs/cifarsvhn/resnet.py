...
#import spikingjelly.activation_based.functional as F
...
class Bottleneck(nn.Module):
    ...
    def __init__(self, in_planes, planes, stride=1):
        ...
        self.conv1 = layer.Conv2d(in_planes, planes, kernel_size=1, bias=False)
        self.bn1 = layer.BatchNorm2d(planes)


        self.conv2 = layer.Conv2d(planes, planes, kernel_size=3, stride=stride, padding=1, bias=False)
        self.bn2 = layer.BatchNorm2d(planes)
        self.conv3 = layer.Conv2d(planes, self.expansion*planes, kernel_size=1, bias=False)
        self.bn3 = layer.BatchNorm2d(self.expansion*planes)
...
class ResNet(nn.Module):
    def __init__(self, block, num_blocks, num_classes=10):
        ...
        self.conv1 = layer.Conv2d(3, 64, kernel_size=3, stride=1, padding=1, bias=False)
...
def ResNet19(num_classes):
    return ResNet(BasicBlock, [3,3,2], num_classes)
